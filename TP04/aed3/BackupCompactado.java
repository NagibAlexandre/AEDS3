...
public class BackupCompactado {
    ...
    public static void backupMenu() throws Exception {
        try {
            ...
            System.out.println(
                    opc == 1 ? "+------------------------------+" : "+---------------------------------------+");
            System.out.println(
                    opc == 1 ? "|       Você gostaria de       |" : "|            Você gostaria de           |");
            System.out.println(
                    opc == 1 ? "|   Fazer backup e Codificar   |" : "|               Decodificar             |");
            System.out.println(
                    opc == 1 ? "+------------------------------+" : "+---------------------------------------+");
            System.out.println(
                    opc == 1 ? "| [ 1 ] Todos os arquivos.     |" : "| [ 1 ] Todos os arquivos.              |");
            System.out.println(
                    opc == 1 ? "| [ 2 ] Um arquivo específico. |" : "| [ 2 ] Todas as versões de um arquivo. |");
            System.out.println(
                    opc == 1 ? "+------------------------------+" : "+---------------------------------------+");
            int opc2 = sc.nextInt();
